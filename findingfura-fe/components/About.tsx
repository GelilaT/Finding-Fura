      ...
      <div id='#about'>
        ...
        <div className='m-10 ml-20'>
            ...
            <div className='flex items-center '>
                ...
                <div className="absolute top-5 -right-3/4 w-[600px] bg-white bg-opacity-50 backdrop-blur-lg border border-white border-opacity-30 rounded-lg h-fit shadow-md hover:scale-105 ease-in-out duration-300 hover:backdrop-blur-none hover:bg-opacity-90">
                    <p className="px-10 py-5 leading-8">Finding Fura is an online feminist magazine that aims to create a platform that fosters nuanced and critical discourse, building narratives around key issues such as politics, national conversations, STEM, history, literature, and everyday life from a feminist perspective.</p>
                    <p className="px-10 py-5 leading-8">
            ...
            <div className='flex items-center justify-center bg-[#AA163F] py-12 gap-5 rounded-3xl mt-32 text-white'>
