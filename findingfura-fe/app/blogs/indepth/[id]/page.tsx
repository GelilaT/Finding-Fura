...
interface IndepthDetailProps {}

const IndepthDetail: FunctionComponent<IndepthDetailProps> = () => {
  ...
  if (!blog) {
    return <div className="mx-4 md:mx-20">No blog found.</div>;
  }
