    ...
    <div>
      <div className="relative bg-[#FFCE1B] bg-opacity-15 m-3 border-none rounded-md">
        <div className="absolute top-3 left-20">
          ...
          <CurvedPic imagesrc="/images/halifet.png" imagetitle="One of our authors" classname="w-40 h-40 hover:scale-105 ease-in-out duration-300"/>
          </div>
      ...
      <a href="mailto:general@findingfura.com?subject=Request to join fura’s volunteers’ community" className="absolute -bottom-12 left-1/2 transform -translate-x-1/2 w-24 h-24 rounded-full bg-[#AA163F] border-8 border-white text-white tracking-widest text-xs animate-rotate">
      ...
      <div className="relative max-w-screen mx-10 mt-20  h-[500px] rounded-3xl p-10 hover:scale-105 ease-in-out duration-300 ">
